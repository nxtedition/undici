...
function consumeStart (consume) {
  ...
  if (state.endEmitted) {
    // consumeStart is called as a plain function (not a method), so `this` is
    // undefined in strict mode. Use the consume/state we already have rather
    // than dereferencing `this`, which threw a TypeError on already-ended bodies.
    //
