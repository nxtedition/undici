...
async function writeBlob (abort, body, client, request, socket, contentLength, header, expectsPayload) {
  try {
    // Inside the try: this function is invoked without await and without a
    // .catch(), so a throw before the try becomes an unhandled rejection
    // (process crash) instead of a graceful abort(err)/onError.
